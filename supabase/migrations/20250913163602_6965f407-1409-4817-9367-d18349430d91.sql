...
-- Update the detailed_data column to store comprehensive candidate information
-- This will replace the candidate_details table functionality
...
SET detailed_data = COALESCE(detailed_data, '{}') || cd.detailed_data,
...
DROP TABLE IF EXISTS public.candidate_details;