...
export function CandidateProfile({ children, candidateData, socialLinks = [], projectId }: CandidateProfileProps) {
  ...
  console.log('CandidateProfile - Debug info:', {
    candidateId,
    projectId,
    isOpen,
    candidateDataAvailable: !!candidateData
  });
  ...
  console.log('CandidateProfile - Data status:', {
    hasDetailedData: !!candidateDetail,
    loading,
    error,
    displayDataKeys: Object.keys(displayData),
    detailedDataFields: candidateDetail ? {
      hasBio: !!candidateDetail.bio,
      hasEmployments: !!candidateDetail.employments?.length,
      hasEducations: !!candidateDetail.educations?.length,
      hasProjects: !!candidateDetail.projects?.length
    } : null
  });
            ...
            <div className="flex items-center justify-center py-8">
              <div className="text-center space-y-3">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-medium">Loading detailed profile...</p>
                  <p className="text-xs text-muted-foreground">
                    Fetching employment history, education, and projects
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Showing basic profile information below.
                  </p>
                </div>
              </div>
            </div>
